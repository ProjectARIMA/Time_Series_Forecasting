...
data = pd.read_csv("AirPassengers.csv", parse_dates=['Month']) # Creates a panda's DataFrame object and loads the contents of CSV file in it, and considers the 'month' column as dates. 
